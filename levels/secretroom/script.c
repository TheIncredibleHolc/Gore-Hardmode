...
const LevelScript level_secretroom_entry[] = {
	...
	AREA(1, secretroom_area_1),
		...
		OBJECT(E_MODEL_STAR, -1726, 404, -2186, 0, -90, 0, (6 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_LUIGI, -2211, 404, -2186, 0, -90, 0, (2 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_MARIO, -2332, 404, -2186, 0, -90, 0, (1 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_NETHERPORTAL, -1599, 404, -2186, 0, -90, 0, (7 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_TOAD, -2091, 404, -2186, 0, -90, 0, (3 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_WALUIGI, -1847, 404, -2186, 0, -90, 0, (5 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_WARIO, -1969, 404, -2186, 0, -90, 0, (4 << 16), id_bhvTrophy),
