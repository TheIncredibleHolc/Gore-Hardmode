...
const LevelScript level_secretroom_entry[] = {
	...
	AREA(1, secretroom_area_1),
		...
		OBJECT(E_MODEL_NONE, 771, 448, -2376, 0, -149, 0, (6 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_NONE, 523, 448, -2793, 0, -149, 0, (2 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_NONE, 462, 448, -2897, 0, -149, 0, (1 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_NONE, 835, 448, -2267, 0, -149, 0, (7 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_NONE, 585, 448, -2690, 0, -149, 0, (3 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_NONE, 709, 448, -2480, 0, -149, 0, (5 << 16), id_bhvTrophy),
		OBJECT(E_MODEL_NONE, 647, 448, -2585, 0, -149, 0, (4 << 16), id_bhvTrophy),
