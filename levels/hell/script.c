...
const LevelScript level_hell_entry[] = {
	...
	AREA(1, hell_area_1),
		...
		OBJECT(E_MODEL_HELLTHWOMPER, -213, 2888, 3150, 0, -90, 0, (4 << 16), id_bhvThwomp),
		...
		OBJECT(E_MODEL_HELL_DORRIE, 1367, 128, 12678, 0, 0, 0, 0x00000000, id_bhvGorrie),
		OBJECT(MODEL_NONE, 78, 319, 13706, 0, 90, 0, 0x00000000, id_bhvNetherPortal),
		...
		OBJECT(E_MODEL_NONE, 1630, 1863, 3183, 0, 90, 0, 0x00010000, id_bhvFadingWarp),
		OBJECT(E_MODEL_NONE, 4708, 266, 496, 0, 0, 0, 0x00020000, id_bhvFadingWarp),
