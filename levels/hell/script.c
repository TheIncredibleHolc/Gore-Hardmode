...
const LevelScript level_hell_entry[] = {
	...
	AREA(1, hell_area_1),
		...
		OBJECT(MODEL_NONE, 758, 465, -7344, 0, 0, 0, 0x00000000, id_bhvFlamethrower),
		...
		OBJECT(MODEL_NONE, 0, 1806, -11532, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 0, 1588, -11532),
